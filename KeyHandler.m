...
-(KeyHandler *)init {
    ...
    if(!self)
        return nil;
    self.translationKeys=[[NSArray alloc] initWithObjects:@"trnsl.1.1.20151022T101327Z.947a48f231e6aa6e.7e71b163761e2e6791c492f9448b63e1c1f27a2e", @"trnsl.1.1.20160116T172821Z.1f08aedad7321adc.c61d63de33f7b02ef4fc0ff70bab33484e4f099b", nil];
    self.dictionaryKeys=[[NSArray alloc] initWithObjects:@"dict.1.1.20151022T180334Z.52a72548fccdbcf3.fe30ded92dd2687f0229f3ebc9709f4e27891329", nil];
